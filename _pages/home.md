...
<br/>
Our expertise focuses on medical imaging for disease detection and diagnosis. AI skillfully detects abnormalities—such as tumors, fractures, and infections—and facilitates early diagnosis of cancers, cardiovascular diseases, and neurological disorders. It precisely outlines anatomical structures and lesions, supporting surgical planning, radiation therapy, and other interventions. Additionally, AI distinguishes benign from malignant lesions, classifies disease subtypes, and informs tailored treatment strategies. It quantifies tumor volume, organ size, and vascular features while monitoring disease progression and treatment outcomes. By integrating data from multiple imaging modalities, patient demographics, and laboratory results, AI delivers cohesive, comprehensive insights. We specialize in X-ray tomographic imaging, photoacoustic imaging, and advanced image reconstruction and analysis. Our work advances innovative theories, methods, software, and hardware systems for clinical applications. We seek collaboration with partners and funding agencies on transformative, high-impact projects.</p>
...
<div markdown="0" id="carousel" class="carousel slide" data-ride="carousel" data-interval="2500" data-pause="hover" >
    ...
    <div class="carousel-inner" markdown="0">
        ...
        <div class="item">
            <a href="https://axiv.org/pdf/2306.08610v7">
                <img src="{{ site.url }}{{ site.baseurl }}/images/imgfile.png" alt="Slide 3" width="800" height="600"/>
            </a>
        </div>
