...
<div class="image-gallery"> 
     <a href="{{ site.url }}{{ site.baseurl }}/images/Slide1.PNG" class="image-link" onclick="openModal("{{ site.url }}{{ site.baseurl }}/images/Slide1.PNG", 'Image 1'); return false;"><img id="img1" src="{{ site.url }}{{ site.baseurl }}/images/Slide1.PNG" width="80" height="60"/></a>
